    ...
    public void autoDesenho() {
        ...
        if(!paralisia()){
            ...
            if(this.intervaloTiro == timer){
                ...
                /**
                 * Documentação (CORREÇÃO FINAL DO BUG DE SPRITE):
                 * A lógica de "reviver" AGORA verifica o 'movDirecao'.
                 */
                 if(this.movDirecao.equals("Horizontal")){
                     // Se move horizontal, o sprite depende de bRight
                     if(bRight){
                        this.setiImage("Dir_"+this.nomeImagem);
                     } else {
                        this.setiImage("Esq_"+this.nomeImagem);
                     ...
                     // Se move vertical, o sprite depende de projDirecao
